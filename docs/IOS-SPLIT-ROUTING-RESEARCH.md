...
The strict profile was imported and activated in all three applications on a physical iPhone 16 Pro Max running iOS 26.5.2 through WebDriverAgent over USB. The normal access-network IPv4 was `185.70.54.121`.

| Client | VPN transport used | Foreign IPv4 | Curated RU-domain IPv4 | Foreign IPv6 | DNS observation | Result |
|---|---|---|---|---|---|---|
| Shadowrocket | P0 REALITY | `87.58.144.192` via VPN | `185.70.54.121` direct | `2a04:3540:1000:310:a4a4:73ff:fecc:7c4b` via VPN | VPN exit plus Cloudflare resolvers; access-network resolver not observed | PASS |
| Happ | P0 REALITY | `87.58.144.192` via VPN | `185.70.54.121` direct | Explicit connection failure; no native IPv6 leak | Cloudflare and Google resolvers; access-network resolver not identified | PASS with DNS warning |
| INCY | P2 Hysteria2 | `108.61.103.103` via VPN | `185.70.54.121` direct | `2a05:f480:1400:2ef1:5400:6ff:fe61:c069` via VPN | Google and VPN-provider-side resolvers; no Cloudflare or access-network resolver observed | PASS |
