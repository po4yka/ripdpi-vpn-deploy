...
| **Jinja2 templates (139)** | **`scripts/check-templates-render.py`** | renders all 139 role templates against synthetic + example data | n/a | Catches Jinja syntax errors, JSON-invalid output for `*.json.j2`, nginx parse errors for site configs. |
