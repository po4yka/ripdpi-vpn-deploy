...
updated: 2026-09-07
related_tasks: []
status_detail: Archive-readiness regression exposed pre-OpenSpec evidence history; adding a scoped validator fix and exact regression before final review.
---
