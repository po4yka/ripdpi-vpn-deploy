...
staging: blocked
staging_evidence: "No isolated staging inventory or matching private inputs are available for the required disabled and log-only dry-run; no provider apply is claimed."
live: not_applicable
