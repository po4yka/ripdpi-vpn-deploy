...
|---|---|---|---|
| REQ-ZIZMOR-PIN | CIC-1786296210585916 | Exact mise pin, CI archive checksum, observed `zizmor --version`, and parity contract test | passed |
| REQ-ZIZMOR-SCOPE | CIC-1786296210585916 | Scoped `.github` plus `.pre-commit-config.yaml` invocation and vendored-fixture exclusion test | passed |
| REQ-ZIZMOR-FAIL-CLOSED | CIC-1786296210585916 | Strict regular-persona scan, executable actionable/malformed/SARIF negative fixtures, `make ci-fast`, and required-job dependency | passed |
| REQ-ZIZMOR-ZERO-BASELINE | CIC-1786296210350045 | Reusable Rust workflow focused tests and scoped analyzer | passed |
| REQ-ZIZMOR-ZERO-BASELINE | CIC-1786296210412999 | Base-ref workflow focused tests and scoped analyzer | passed |
| REQ-ZIZMOR-ZERO-BASELINE | CIC-1786296210451056 | Deployment workflow/Terraform contract tests and scoped analyzer | passed |
| REQ-ZIZMOR-ZERO-BASELINE | CIC-1786296210479892 | Reproducible-pin contract tests and scoped analyzer | passed |
| REQ-ZIZMOR-ZERO-BASELINE | CIC-1786296210502723 | Checkout credential-persistence contract tests and scoped analyzer | passed |
| REQ-ZIZMOR-ZERO-BASELINE | CIC-1786296210530158 | Dependabot cooldown contract test and scoped analyzer | passed |
| REQ-ZIZMOR-ZERO-BASELINE | CIC-1786296210558254 | Release create/upload/draft recovery contract tests, exact-tag commit binding, and scoped analyzer | passed |
| REQ-ZIZMOR-LEAST-PRIVILEGE | CIC-1786296210502723 | No persisted checkout credentials across owned workflows | passed |
| REQ-ZIZMOR-LEAST-PRIVILEGE | CIC-1786296210585916 | Offline no-token CI job with read-only permissions and temporary install | passed |
| REQ-ZIZMOR-CANONICAL-GATE | CIC-1786296210585916 | `make zizmor-check`, `make ci-fast`, and local/CI invocation parity tests | passed |
| REQ-ZIZMOR-ROLLBACK | CIC-1786296210585916 | Focused commit history, final diff review, and documented rollback boundary | passed |
