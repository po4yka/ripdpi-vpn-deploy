...
- [x] CIC-1786296210558254 Replace the redundant release-upload action with built-in `gh`, use one resolved tag for tag and manual runs, create a missing release, recover an interrupted draft, and prove release asset and rerun behavior with focused tests #feature !high @item:CIC-1786295418152915 @blocked_by:CIC-1786296210530158
