...
- [ ] OPS-1787496118906369 Validate each COHORTS slug against the known group_vars/vpn-*.yml set during inventory rendering, failing loudly on unknown values #bug !high @item:OPS-1787496414433523
...
- [ ] OPS-1787496118906901 Abort inventory rendering on duplicate host aliases across HOSTS pairs (or namespace aliases while keeping server_hostname as a host var) #bug !low @item:OPS-1787496414433523
