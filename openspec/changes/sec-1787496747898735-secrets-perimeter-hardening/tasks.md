...
- [x] SEC-1787496118907178 Run named gates: molecule scenarios for touched roles, security-verify playbook in check mode, make ci-fast, make validate #test !high @item:SEC-1787496747898735
