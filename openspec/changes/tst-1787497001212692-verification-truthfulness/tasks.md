...
- [x] TST-1787496118907291 Add an idempotence phase to the xray molecule sequence or document the omission in-file alongside the TESTING.md row #bug !low @item:TST-1787497001212692
- [x] TST-1787496118906595 Rewrite the amneziawg converge to execute the role via include_role against existing stub binaries rather than hand-rendering awg0.conf.j2 in the play #bug !high @item:TST-1787497001212692
