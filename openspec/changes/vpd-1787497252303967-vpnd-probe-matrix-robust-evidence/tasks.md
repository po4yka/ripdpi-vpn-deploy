...
- [ ] VPD-1787497252661429 Enable kill_on_drop on the capture path used by cells and add a timeout test asserting child termination #bug !high @item:VPD-1787497252303967
- [ ] VPD-1787497252679177 Wrap the control invocation in the cell timeout budget with Unknown-on-expiry handling and test #bug !high @item:VPD-1787497252303967
...
- [ ] VPD-1787497252715025 Reject duration 0 in config validation and narrow windows() onset to Blocked/Throttled with unit tests for both; refresh the insta snapshot and docs/PROBE-MATRIX.md #bug !high @item:VPD-1787497252303967
