...
| REQ-JSON-FLAG-HONESTY | VPD-1787497435909140 | host_crud.rs json_flag test pins --json array emission for host list (empty and non-empty) and compact show, plus unchanged pretty human mode; probe_matrix.rs json_summary unit test pins the machine-readable report-path summary printed under --json; help text names the supported subcommands | passed |
