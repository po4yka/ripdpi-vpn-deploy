...
# ---------------------------------------------------------------------------
CI_BASE_VARS="vpn.enable_amneziawg=false vpn.enable_geodata=false vpn.enable_backup=false vpn.enable_monitoring=false vpn.enable_watchdog=false vpn.enable_warp_outbound=false vpn.enable_honeypot=false vpn.enable_policy_ratelimit=false vpn.enable_dns_morph_bridge=false vpn.enable_hysteria_realm=false"
...
profile_extra_vars() {
  case "$1" in
    ...
    p0p4)
      ...
      echo "vpn.enable_xray_reality=true vpn.enable_nginx_xhttp=false vpn.enable_hysteria=false vpn.enable_amneziawg=false vpn.enable_geodata=false vpn.enable_backup=false vpn.enable_monitoring=false vpn.enable_watchdog=false vpn.enable_warp_outbound=false vpn.enable_honeypot=false vpn.enable_policy_ratelimit=false vpn.enable_dns_morph_bridge=true vpn.enable_hysteria_realm=false" ;;
    p0p5)
