...
mod tests {
    ...
    #[test]
    fn durations_parse_valid_units() {
    ...
    #[test]
    fn durations_reject_malformed_units() {
    ...
    fn windows_record_blocked_onset_and_ok_recovery() {
        ...
        assert_eq!(windows[0].onset_unix_ms, Some(100));
        assert_eq!(windows[0].recovery_unix_ms, Some(200));
    }
